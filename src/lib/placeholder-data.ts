...
export const faculty: Faculty[] = [
  ...
  { id: 'FAC003', name: 'Dr. Grace Hopper', email: 'hopper@example.com', code: 'HPR03', designation: 'Assistant Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: ['Lab Incharge'], streak: 15, profileCompleted: 85, points: 3400, allotedSubjects: ['SUB002', 'SUB022', 'SUB021'], maxWeeklyHours: 22, designatedYear: 1 },
  ...
  { id: 'FAC011', name: 'Dr. Marie Curie', email: 'curie@example.com', code: 'CRE11', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 33, profileCompleted: 100, points: 4800, allotedSubjects: ['SUB009', 'SUB010'], maxWeeklyHours: 20, designatedYear: 3 },
  ...
  { id: 'FAC015', name: 'Dr. Rosalind Franklin', email: 'franklin@example.com', code: 'FRN15', designation: 'Assistant Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 22, profileCompleted: 95, points: 4100, allotedSubjects: ['SUB010', 'SUB012'], maxWeeklyHours: 22, designatedYear: 3 },
