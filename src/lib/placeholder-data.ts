...
export const subjects: Subject[] = [
  { id: 'SUB001', name: 'Intro to Programming', code: 'CS101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Basics","topics":["Variables","Data Types"],"weightage":"50%"},{"name":"Control Flow","topics":["If/Else","Loops"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB002', name: 'Programming Lab I', code: 'CS102', type: 'lab', semester: 1, syllabus: '{"modules":[{"name":"Lab Work","topics":["Basic Programs"],"weightage":"100%"}]}', department: 'Computer Engineering' },
  { id: 'SUB003', name: 'Digital Logic Design', code: 'EC101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Boolean Algebra","topics":["Theorems","Gates"],"weightage":"50%"},{"name":"Combinational Circuits","topics":["Adders","Subtractors"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB004', name: 'Applied Mathematics I', code: 'AM101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Calculus","topics":["Limits","Derivatives"],"weightage":"50%"},{"name":"Linear Algebra","topics":["Matrices","Vectors"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB021', name: 'Communication Skills', code: 'HU101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Verbal","topics":["Presentation","Group Discussion"],"weightage":"50%"},{"name":"Written","topics":["Email Etiquette","Report Writing"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB022', name: 'Engineering Drawing', code: 'ME101', type: 'lab', semester: 1, syllabus: '{"modules":[{"name":"Projections","topics":["Orthographic","Isometric"],"weightage":"50%"},{"name":"CAD","topics":["2D Sketching","3D Modeling"],"weightage":"50%"}]}', department: 'Computer Engineering' },

  { id: 'SUB005', name: 'Data Structures', code: 'CS201', type: 'theory', semester: 3, syllabus: '{"modules":[{"name":"Arrays and Strings","topics":["Sorting","Searching"],"weightage":"25%"},{"name":"Linked Lists","topics":["Singly","Doubly"],"weightage":"25%"},{"name":"Trees","topics":["BST","AVL"],"weightage":"25%"},{"name":"Graphs","topics":["BFS","DFS"],"weightage":"25%"}]}', department: 'Computer Engineering' },
  { id: 'SUB006', name: 'Data Structures Lab', code: 'CS202', type: 'lab', semester: 3, syllabus: '{"modules":[{"name":"Lab Work","topics":["Implementing DS"],"weightage":"100%"}]}', department: 'Computer Engineering' },
  { id: 'SUB007', name: 'Object Oriented Programming', code: 'CS203', type: 'theory', semester: 3, syllabus: '{"modules":[{"name":"OOP Concepts","topics":["Inheritance","Polymorphism"],"weightage":"50%"},{"name":"Java Basics","topics":["Classes","Objects"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB008', name: 'Applied Mathematics III', code: 'AM201', type: 'theory', semester: 3, syllabus: '{"modules":[{"name":"Complex Variables","topics":["Functions","Integration"],"weightage":"50%"},{"name":"Transforms","topics":["Laplace","Fourier"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  
  { id: 'SUB009', name: 'Database Management Systems', code: 'CS301', type: 'theory', semester: 5, syllabus: '{"modules":[{"name":"SQL Basics","topics":["SELECT","UPDATE","DELETE"],"weightage":"40%"},{"name":"Normalization","topics":["1NF","2NF","3NF"],"weightage":"60%"}]}', department: 'Computer Engineering' },
  ...
  { id: 'SUB011', name: 'Operating Systems', code: 'CS303', type: 'theory', semester: 5, syllabus: '{"modules":[{"name":"Process Management","topics":["Scheduling","Deadlocks"],"weightage":"50%"},{"name":"Memory Management","topics":["Paging","Segmentation"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB012', name: 'Computer Networks', code: 'CS304', type: 'theory', semester: 5, syllabus: '{"modules":[{"name":"OSI Model","topics":["Layers"],"weightage":"50%"},{"name":"TCP/IP","topics":["Sockets","Ports"],"weightage":"50%"}]}', department: 'Computer Engineering' },

  { id: 'SUB013', name: 'Machine Learning', code: 'AI401', type: 'theory', semester: 7, syllabus: '{"modules":[{"name":"Supervised Learning","topics":["Regression","Classification"],"weightage":"50%"},{"name":"Unsupervised Learning","topics":["Clustering","Dimensionality Reduction"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB014', name: 'Cryptography and Security', code: 'CS402', type: 'theory', semester: 7, syllabus: '{"modules":[{"name":"Symmetric Key","topics":["DES","AES"],"weightage":"50%"},{"name":"Asymmetric Key","topics":["RSA","ECC"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB015', name: 'Cloud Computing', code: 'CS403', type: 'theory', semester: 7, syllabus: '{"modules":[{"name":"Virtualization","topics":["Hypervisors"],"weightage":"50%"},{"name":"Cloud Models","topics":["IaaS","PaaS","SaaS"],"weightage":"50%"}]}', department: 'Computer Engineering' },
  { id: 'SUB016', name: 'AI Lab', code: 'AI402', type: 'lab', semester: 7, syllabus: '{"modules":[{"name":"Lab Work","topics":["Model Training"],"weightage":"100%"}]}', department: 'Computer Engineering' },
...
export const faculty: Faculty[] = [
  { id: 'FAC001', name: 'Dr. Alan Turing', email: 'turing@example.com', code: 'TNG01', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: ['HOD'], streak: 45, profileCompleted: 90, points: 5200, allottedSubjects: ['SUB001', 'SUB005'], maxWeeklyHours: 20, designatedYear: 1 },
  { id: 'FAC002', name: 'Dr. Ada Lovelace', email: 'lovelace@example.com', code: 'LCE02', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 8, profileCompleted: 80, points: 2100, allottedSubjects: ['SUB001'], maxWeeklyHours: 18, designatedYear: 1 },
  { id: 'FAC003', name: 'Dr. Grace Hopper', email: 'hopper@example.com', code: 'HPR03', designation: 'Assistant Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: ['Lab Incharge'], streak: 15, profileCompleted: 85, points: 3400, allottedSubjects: ['SUB002'], maxWeeklyHours: 22, designatedYear: 1 },
  ...
  { id: 'FAC006', name: 'Dr. Abhinav Gupta', email: 'abhinav@example.com', code: 'GPT06', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 25, profileCompleted: 95, points: 4500, allottedSubjects: ['SUB013'], maxWeeklyHours: 20, designatedYear: 4 },
  ...
  { id: 'FAC008', name: 'Prof. Minerva McGonagall', email: 'mcgonagall@example.com', code: 'MGL08', designation: 'Professor', employmentType: 'full-time', department: 'Transfiguration', roles: ['HOD'], streak: 50, profileCompleted: 100, points: 6000, allottedSubjects: [], maxWeeklyHours: 20, designatedYear: 1 },
  { id: 'FAC009', name: 'Prof. Walter White', email: 'white@example.com', code: 'WHT09', designation: 'Lecturer', employmentType: 'contract', department: 'Chemistry', roles: [], streak: 1, profileCompleted: 40, points: 200, allottedSubjects: [], maxWeeklyHours: 12, designatedYear: 1 },
  { id: 'FAC010', name: 'Prof. Indiana Jones', email: 'jones@example.com', code: 'JNS10', designation: 'Professor', employmentType: 'full-time', department: 'Archaeology', roles: [], streak: 12, profileCompleted: 75, points: 2800, allottedSubjects: [], maxWeeklyHours: 20, designatedYear: 2 },
  { id: 'FAC011', name: 'Dr. Marie Curie', email: 'curie@example.com', code: 'CRE11', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 33, profileCompleted: 100, points: 4800, allottedSubjects: ['SUB009'], maxWeeklyHours: 20, designatedYear: 3 },
  { id: 'FAC012', name: 'Dr. Nikola Tesla', email: 'tesla@example.com', code: 'TSL12', designation: 'Professor', employmentType: 'full-time', department: 'Electronics Engineering', roles: ['HOD'], streak: 40, profileCompleted: 90, points: 5500, allottedSubjects: ['SUB017', 'SUB019'], maxWeeklyHours: 20, designatedYear: 2 },
  { id: 'FAC013', name: 'Dr. Isaac Newton', email: 'newton@example.com', code: 'NTN13', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 20, profileCompleted: 88, points: 3900, allottedSubjects: ['SUB004'], maxWeeklyHours: 18, designatedYear: 1 },
  { id: 'FAC014', name: 'Dr. Albert Einstein', email: 'einstein@example.com', code: 'EST14', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 18, profileCompleted: 92, points: 3600, allottedSubjects: ['SUB008'], maxWeeklyHours: 18, designatedYear: 2 },
  { id: 'FAC015', name: 'Dr. Rosalind Franklin', email: 'franklin@example.com', code: 'FRN15', designation: 'Assistant Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 22, profileCompleted: 95, points: 4100, allottedSubjects: ['SUB010', 'SUB012'], maxWeeklyHours: 22, designatedYear: 3 },
  { id: 'FAC016', name: 'Dr. Stephen Hawking', email: 'hawking@example.com', code: 'HWK16', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 30, profileCompleted: 98, points: 4700, allottedSubjects: ['SUB015', 'SUB014'], maxWeeklyHours: 20, designatedYear: 4 },
  { id: 'FAC017', name: 'Prof. Charles Xavier', email: 'xavier@example.com', code: 'XVR17', designation: 'Professor', employmentType: 'full-time', department: 'Electronics Engineering', roles: [], streak: 10, profileCompleted: 80, points: 2500, allottedSubjects: ['SUB018'], maxWeeklyHours: 18, designatedYear: 2 },
  { id: 'FAC018', name: 'Prof. Albus Dumbledore', email: 'dumbledore@example.com', code: 'DDR18', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 55, profileCompleted: 100, points: 6500, allottedSubjects: ['SUB007'], maxWeeklyHours: 20, designatedYear: 2 },
  { id: 'FAC019', name: 'Prof. Severus Snape', email: 'snape@example.com', code: 'SNP19', designation: 'Assistant Professor', employmentType: 'part-time', department: 'Electronics Engineering', roles: [], streak: 5, profileCompleted: 65, points: 1500, allottedSubjects: ['SUB020'], maxWeeklyHours: 10, designatedYear: 4 },
  { id: 'FAC020', name: 'Prof. Annalise Keating', email: 'keating@example.com', code: 'KTG20', designation: 'Professor', employmentType: 'full-time', department: 'Computer Engineering', roles: [], streak: 14, profileCompleted: 85, points: 3200, allottedSubjects: ['SUB016'], maxWeeklyHours: 22, designatedYear: 4 },
];
