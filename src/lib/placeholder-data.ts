...
export const subjects: Subject[] = [
  { id: 'SUB001', name: 'Intro to Programming', code: 'CS101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Basics","topics":["Variables","Data Types"],"weightage":"50%"},{"name":"Control Flow","topics":["If/Else","Loops"],"weightage":"50%"}]}', department: 'Computer Engineering', priority: 'High' },
  ...
  { id: 'SUB003', name: 'Digital Logic Design', code: 'EC101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Boolean Algebra","topics":["Theorems","Gates"],"weightage":"50%"},{"name":"Combinational Circuits","topics":["Adders","Subtractors"],"weightage":"50%"}]}', department: 'Computer Engineering', priority: 'High' },
  { id: 'SUB004', name: 'Applied Mathematics I', code: 'AM101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Calculus","topics":["Limits","Derivatives"],"weightage":"50%"},{"name":"Linear Algebra","topics":["Matrices","Vectors"],"weightage":"50%"}]}', department: 'Computer Engineering', priority: 'Non Negotiable' },
  { id: 'SUB021', name: 'Communication Skills', code: 'HU101', type: 'theory', semester: 1, syllabus: '{"modules":[{"name":"Verbal","topics":["Presentation","Group Discussion"],"weightage":"50%"},{"name":"Written","topics":["Email Etiquette","Report Writing"],"weightage":"50%"}]}', department: 'Computer Engineering', priority: 'Medium' },
  ...
  { id: 'SUB007', name: 'Object Oriented Programming', code: 'CS203', type: 'theory', semester: 3, syllabus: '{"modules":[{"name":"OOP Concepts","topics":["Inheritance","Polymorphism"],"weightage":"50%"},{"name":"Java Basics","topics":["Classes","Objects"],"weightage":"50%"}]}', department: 'Computer Engineering', priority: 'High' },
  { id: 'SUB008', name: 'Applied Mathematics III', code: 'AM201', type: 'theory', semester: 3, syllabus: '{"modules":[{"name":"Complex Variables","topics":["Functions","Integration"],"weightage":"50%"},{"name":"Transforms","topics":["Laplace","Fourier"],"weightage":"50%"}]}', department: 'Computer Engineering', priority: 'High' },
  ...
  { id: 'SUB015', name: 'Cloud Computing', code: 'CS403', type: 'theory', semester: 7, syllabus: '{"modules":[{"name":"Virtualization","topics":["Hypervisors"],"weightage":"50%"},{"name":"Cloud Models","topics":["IaaS","PaaS","SaaS"],"weightage":"50%"}]}', department: 'Computer Engineering', priority: 'High' },
  ...
  { id: 'SUB017', name: 'Analog Circuits', code: 'EC201', type: 'theory', semester: 3, department: 'Electronics Engineering', priority: 'High' },
