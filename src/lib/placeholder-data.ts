...
export const faculty: Faculty[] = [
  ...
  { id: 'FAC006', name: 'Dr. Andrew Ng', email: 'ng@example.com', code: '210401002006', designation: 'Professor', employmentType: 'full-time', departmentId: 'DEPT_AIML', roles: ['HOD'], streak: 40, avatar: 'https://avatar.vercel.sh/ng@example.com.png', profileCompleted: 98, points: 6000, allottedSubjects: ['SUB101', 'SUB104', 'SUB403'], maxWeeklyHours: 20, designatedYear: 4, dateOfJoining: '2008-05-12T00:00:00.000Z' },
  { id: 'FAC007', name: 'Dr. Fei-Fei Li', email: 'li@example.com', code: '210401002007', designation: 'Professor', employmentType: 'full-time', departmentId: 'DEPT_AIML', roles: [], streak: 35, avatar: 'https://avatar.vercel.sh/li@example.com.png', profileCompleted: 95, points: 5500, allottedSubjects: ['SUB105', 'SUB107', 'SUB404'], maxWeeklyHours: 20, designatedYear: 4, dateOfJoining: '2009-09-01T00:00:00.000Z' },
  { id: 'FAC008', name: 'Prof. Yann LeCun', email: 'lecun@example.com', code: '220302002008', designation: 'Assistant Professor', employmentType: 'full-time', departmentId: 'DEPT_AIML', roles: [], streak: 28, avatar: 'https://avatar.vercel.sh/lecun@example.com.png', profileCompleted: 90, points: 4500, allottedSubjects: ['SUB102', 'SUB103', 'SUB106', 'SUB401', 'SUB402'], maxWeeklyHours: 22, designatedYear: 3, dateOfJoining: '2019-02-15T00:00:00.000Z' },
