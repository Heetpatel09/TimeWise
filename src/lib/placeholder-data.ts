...
export const subjects: Subject[] = [
  ...
  // CSE Semester 3
  { id: 'SUB006', name: 'Data Structures', code: 'CS201', type: 'theory', semester: 3, department: DEPARTMENTS.CSE, priority: 'High' },
  { id: 'SUB007', name: 'Data Structures Lab', code: 'CS202', type: 'lab', semester: 3, department: DEPARTMENTS.CSE },
  { id: 'SUB008', name: 'Object Oriented Programming', code: 'CS203', type: 'theory', semester: 3, department: DEPARTMENTS.CSE, priority: 'High' },
  { id: 'SUB009', name: 'Applied Mathematics III', code: 'AM201', type: 'theory', semester: 3, department: DEPARTMENTS.CSE, priority: 'High' },
  { id: 'SUB010', name: 'Computer Architecture', code: 'CS204', type: 'theory', semester: 3, department: DEPARTMENTS.CSE, priority: 'Medium' },

  // CSE Semester 5
  { id: 'SUB011', name: 'Database Management Systems', code: 'CS301', type: 'theory', semester: 5, department: DEPARTMENTS.CSE, priority: 'High' },
  { id: 'SUB012', name: 'DBMS Lab', code: 'CS302', type: 'lab', semester: 5, department: DEPARTMENTS.CSE },
  { id: 'SUB013', name: 'Operating Systems', code: 'CS303', type: 'theory', semester: 5, department: DEPARTMENTS.CSE, priority: 'High' },
  { id: 'SUB014', name: 'Operating Systems Lab', code: 'CS304', type: 'lab', semester: 5, department: DEPARTMENTS.CSE },
  { id: 'SUB015', name: 'Computer Networks', code: 'CS305', type: 'theory', semester: 5, department: DEPARTMENTS.CSE, priority: 'High' },

  // CSE Semester 7
  { id: 'SUB016', name: 'Cryptography and Security', code: 'CS402', type: 'theory', semester: 7, department: DEPARTMENTS.CSE, priority: 'High' },
  { id: 'SUB017', name: 'Cloud Computing', code: 'CS403', type: 'theory', semester: 7, department: DEPARTMENTS.CSE, priority: 'High' },
  { id: 'SUB018', name: 'Project I', code: 'CS450', type: 'lab', semester: 7, department: DEPARTMENTS.CSE },
  
  // AI & ML Semester 5
  { id: 'SUB101', name: 'Intro to AI', code: 'AI301', type: 'theory', semester: 5, department: DEPARTMENTS.AIML, priority: 'High' },
  { id: 'SUB102', name: 'Python for ML', code: 'AI302', type: 'lab', semester: 5, department: DEPARTMENTS.AIML },
  { id: 'SUB103', name: 'Linear Algebra for ML', code: 'AI303', type: 'theory', semester: 5, department: DEPARTMENTS.AIML, priority: 'High' },

  // AI & ML Semester 7
  { id: 'SUB104', name: 'Machine Learning', code: 'AI401', type: 'theory', semester: 7, department: DEPARTMENTS.AIML, priority: 'High' },
  { id: 'SUB105', name: 'Deep Learning', code: 'AI402', type: 'theory', semester: 7, department: DEPARTMENTS.AIML, priority: 'High' },
  { id: 'SUB106', name: 'Natural Language Processing', code: 'AI403', type: 'theory', semester: 7, department: DEPARTMENTS.AIML, priority: 'High' },
  { id: 'SUB107', name: 'AI Lab', code: 'AI404', type: 'lab', semester: 7, department: DEPARTMENTS.AIML },
  
  // ECE Subjects
  { id: 'SUB201', name: 'Analog Circuits', code: 'EC201', type: 'theory', semester: 3, department: DEPARTMENTS.ECE, priority: 'High' },
  { id: 'SUB202', name: 'Digital Electronics', code: 'EC202', type: 'theory', semester: 3, department: DEPARTMENTS.ECE, priority: 'High' },
  { id: 'SUB203', name: 'Signals and Systems', code: 'EC301', type: 'theory', semester: 5, department: DEPARTMENTS.ECE, priority: 'High' },
  { id: 'SUB204', name: 'VLSI Design', code: 'EC401', type: 'theory', semester: 7, department: DEPARTMENTS.ECE, priority: 'High' },
...
export const classes: Class[] = [
  ...
  { id: 'CLS001', name: 'CE 2024 (A)', semester: 1, department: DEPARTMENTS.CSE, section: 'A' },
  { id: 'CLS002', name: 'CE 2024 (B)', semester: 1, department: DEPARTMENTS.CSE, section: 'B' },
  { id: 'CLS003', name: 'CE 2023 (A)', semester: 3, department: DEPARTMENTS.CSE, section: 'A' },
  { id: 'CLS004', name: 'CE 2023 (B)', semester: 3, department: DEPARTMENTS.CSE, section: 'B' },
  { id: 'CLS005', name: 'CE 2022 (A)', semester: 5, department: DEPARTMENTS.CSE, section: 'A' },
  { id: 'CLS006', name: 'CE 2021 (A)', semester: 7, department: DEPARTMENTS.CSE, section: 'A' },
  // AI & ML
  { id: 'CLS101', name: 'AIML 2022 (A)', semester: 5, department: DEPARTMENTS.AIML, section: 'A' },
  { id: 'CLS102', name: 'AIML 2021 (A)', semester: 7, department: DEPARTMENTS.AIML, section: 'A' },
  // Electronics
  { id: 'CLS201', name: 'ECE 2023 (A)', semester: 3, department: DEPARTMENTS.ECE, section: 'A' },
  { id: 'CLS202', name: 'ECE 2022 (A)', semester: 5, department: DEPARTMENTS.ECE, section: 'A' },
];
...
export const faculty: Faculty[] = [
  ...
  { id: 'FAC007', name: 'Dr. Fei-Fei Li', email: 'li@example.com', code: 'LI07', designation: 'Professor', employmentType: 'full-time', department: DEPARTMENTS.AIML, roles: [], streak: 35, profileCompleted: 95, points: 5500, allottedSubjects: ['SUB105', 'SUB107'], maxWeeklyHours: 20, designatedYear: 4 },
  { id: 'FAC008', name: 'Prof. Yann LeCun', email: 'lecun@example.com', code: 'LCN08', designation: 'Assistant Professor', employmentType: 'full-time', department: DEPARTMENTS.AIML, roles: [], streak: 28, profileCompleted: 90, points: 4500, allottedSubjects: ['SUB102', 'SUB106'], maxWeeklyHours: 22, designatedYear: 3 },
  { id: 'FAC009', name: 'Dr. Nikola Tesla', email: 'tesla@example.com', code: 'TSL09', designation: 'Professor', employmentType: 'full-time', department: DEPARTMENTS.ECE, roles: ['HOD'], streak: 40, profileCompleted: 90, points: 5500, allottedSubjects: ['SUB201', 'SUB203'], maxWeeklyHours: 20, designatedYear: 2 },
